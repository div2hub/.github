...
- **Data contributions:** Fork [div2hub/game-data](https://github.com/div2hub/game-data), read the [CSV conventions](https://github.com/div2hub/game-data/blob/main/README.md), and open a PR. The validation pipeline will catch formatting issues before review.
